...
extern volatile uint32_t duty_cycle;   // Output PWM duty cycle
extern volatile int32_t target_rpm;    // Desired speed target
extern volatile int32_t motor_speed;   // Measured motor speed
